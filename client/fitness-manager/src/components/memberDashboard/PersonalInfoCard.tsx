...
const PersonalInfoCard = () => {
  ...
  return (
    <DashboardCard
      ...
      footer={<Button className="btn" form="personal-info-form" type="submit">Update</Button>}
    >
      <form id="personal-info-form" onSubmit={handleSubmit(onSubmit)} className="flex flex-col space-y-4">
        <Input
          type="text"
...
async function updatePersonalInfo(data: PersonalInfoType) {
  const res = await patchData(`members/1`, data);
  return res.data;
}
